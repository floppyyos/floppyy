...
export const windowDefinitions: Record<WindowId, WindowDefinition> = {
  ...
  snake: { id: "snake", title: "Snake", icon: "snake", width: 360, height: 390, minWidth: 320, minHeight: 300, noMaximize: true },
  tetris: { id: "tetris", title: "Tetris", icon: "tetris", width: 300, height: 470, minWidth: 260, minHeight: 380, noMaximize: true },
  breakout: { id: "breakout", title: "Breakout", icon: "breakout", width: 450, height: 450, minWidth: 380, minHeight: 340, noMaximize: true },
  "pixel-puzzle": { id: "pixel-puzzle", title: "Pixel Puzzle", icon: "pixelpuzzle", width: 360, height: 410, minWidth: 320, minHeight: 340, noMaximize: true },
  "typing-game": { id: "typing-game", title: "Typing Tutor", icon: "typingtutor", width: 430, height: 340, minWidth: 360, minHeight: 260, noMaximize: true },
